...
const HomeNavigator = () =>(
    <Stack.Navigator>
      ...
      <Stack.Screen name={routes.SAFETY} component={controler.SafetyStackScreen} options={{headerShown:false}}/>
      <Stack.Screen name={routes.CREATE_NEW_FILE} component={controler.CreateNewFileStackScreen} options={{headerShown:false}}/>
      <Stack.Screen name={routes.MISSING_PEOPLE} component={controler.MissingPeopleStackScreen} options={{headerShown:false}}/>
      {/* 
